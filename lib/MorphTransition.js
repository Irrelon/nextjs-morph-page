...
function (_React$Component) {
  ...
  _createClass(MorphTransition, [{
    ...
    value: function onEnter(pageElem) {
      ...
      console.log('onEnter'); // It's safe to reenable scrolling now
      ...
      if (this._sourceMorphElements) {
        ...
        this._sourceMorphElements.forEach(function (sourceItem) {
          promiseArr.push(new Promise(function (resolve) {
            var target = pageElem.querySelector("#".concat(sourceItem.node.id, "[data-morph]"));
        ...
        Promise.all(promiseArr).then(function () {
          ...
          //console.log('Detected ' + this._sourceMorphElements.length + ' new source elements');
    ...
    value: function scanDomForMorphElements(pageElem) {
      var morphElems = pageElem.querySelectorAll('[data-morph]');
      var sourceSnapshot = [];
    ...
    value: function onEntered(pageElem) {
      ...
      setTimeout(function () {
        _this3._sourceMorphElements = _this3.scanDomForMorphElements(pageElem);
        console.log('On entered detected ' + _this3._sourceMorphElements.length + ' new source elements');
      }, 1);
    }
  }, {
    key: "onMorphComplete",
    ...
    value: function onExit() {
      console.log('onExit'); // Disable scrolling until this component has unmounted
