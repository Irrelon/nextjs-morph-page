...
function (_React$Component) {
  ...
  _createClass(MorphTransition, [{
      ...
      if (this._sourceMorphElements) {
        ...
        this._sourceMorphElements.forEach(function (sourceItem) {
          promiseArr.push(new Promise(function (resolve) {
            var target = elem.querySelector("#".concat(sourceItem.node.id, "[data-morph]"));

            if (target) {
              (0, _irrelonMorph.default)(sourceItem, target, parseInt(target.getAttribute('data-morph'), 10) || 600).then(function (morphData) {
                (0, _irrelonMorph.endMorph)(morphData);
                newSourceElems.push(new _irrelonMorph.ScannedNode(target));
                resolve();
              });
            }
          }));
        ...
        Promise.all(promiseArr).then(function () {
          _this2._sourceMorphElements = newSourceElems;
        });
      }
    }
  }, {
    ...
    key: "onEntered",
    value: function onEntered(elem) {
      //console.log('onEntered');
      this.setState({
        state: 'entered'
      });
      var morphElems = elem.querySelectorAll('[data-morph]');
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Transition.default, {
        ...
        onEnter: function onEnter() {
          return _this4.onEnter.apply(_this4, arguments);
        },
        onEntering: function onEntering() {
          return _this4.onEntering.apply(_this4, arguments);
        },
        onEntered: function onEntered() {
          return _this4.onEntered.apply(_this4, arguments);
        },
        onExit: function onExit() {
          return _this4.onExit.apply(_this4, arguments);
        },
        onExiting: function onExiting() {
          return _this4.onExiting.apply(_this4, arguments);
        },
        onExited: function onExited() {
          return _this4.onExited.apply(_this4, arguments);
        }
