...
var morphElement = function morphElement(sourceData, targetData, duration, options) {
  ...
  return new Promise(function (resolve) {
    ...
    var target = targetData.node; // Create a placeholder at the target location to maintain scrolling

    var targetPlaceholder = document.createElement(target.tagName);
    ...
    targetData.parentNode.insertBefore(targetPlaceholder, targetData.nextSibling); // Apply source css to target
...
var cancelAllMorphs = function cancelAllMorphs() {
  console.log('Cancelling all morphs'); // Cancel all morph functions
